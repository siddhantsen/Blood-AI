...
def main():
    ...
    parser.add_argument('--num_attn_blocks', type=int, required=True, help='Number of transformer blocks')
    parser.add_argument('--output', type=str, default='model_save', help='Directory to save trained model')
    parser.add_argument('--batch_size', type=int, required=True, help='Batch size for training')
    parser.add_argument('--embed_dim', type=int, required=True, help='Batch size for training')
    ...
    model_config = FTTransformerConfig(
        ...
        num_attn_blocks=args.num_attn_blocks,  # Number of transformer blocks
        input_embed_dim=args.embed_dim,
